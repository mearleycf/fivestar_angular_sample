...
@Component({
  selector: 'app-coverage-bop',
  templateUrl: './coverage-bop.component.html',
  styleUrls: ['./coverage-bop.component.css']
})
export class CoverageBopComponent implements OnInit {
